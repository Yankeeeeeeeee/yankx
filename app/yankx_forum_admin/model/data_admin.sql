...
--创建用户表
create table yankx_admin
(
    anick varchar(10) primary key,
    apa char(32),
    aemail varchar(30),
    atel varchar(15),
    aimg char(46) default 'me.png'
);
--修改user表的字段uimg，长度改为46
ALTER table yankx_admin modify uimg char(46) default 'me.png';

--创建测试用户
insert into yankx_admin(anick,apa)
        values
        ('tom',md5('123456'));
insert into yankx_admin(anick,apa)
        values
...
grant delete on yankx_forum.* to 'yankx'@localhost;
